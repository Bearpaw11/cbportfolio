    ...
    <div className={classes.AboutMe} id="about">
      ...
      <div className={classes.Container}>
        <div className={classes.Text}>
          ...
          <p>
          As a seasoned Full Stack Web Developer, I bring a unique blend of critical thinking, teamwork, experience working in an agile environment, and a passion for challenges. Armed with a Full Stack Web Development certificate from The University of Arizona and TEKsystems, my skill set encompasses Java, Spring Boot, HTML5, CSS, JavaScript, Bootstrap, React, MySQL, Postgres, and Snowflake.
          <br/> 
          <br/>
